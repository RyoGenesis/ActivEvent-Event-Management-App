                            ...
                            <div class="carousel-item active">
                                <div class="row row-cols-1 row-cols-md-3 g-4 px-3">
                                    @foreach ($featuredEvents as $featuredevent)
                                        @if ($loop->iteration <= 3)
                                            <div class="col">
                                                <a class="card text-decoration-none text-dark h-100" id="carouselcard" href="{{ route('eventdetail', ['id'=>$featuredevent->id]) }}" style="height:max-content">
                                                ...
                                                <a class="card text-decoration-none text-dark h-100" href="{{ route('eventdetail', ['id'=>$pevent->id]) }}" style="height:max-content">
                                                    <div class="row g-0 allign-item-center">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <p class="card-text fw-light">Slot Available: {{$pevent->max_slot == -1 ? 'No Limit' : $pevent->max_slot}}</p>
...
<div class="container mobile-only">
    ...
    <div class="container-fluid mb-4">
        ...
        <div class="row">
            ...
            @else
                <div id="carouselControlFEmini" class="carousel carousel-dark slide" data-bs-interval="false">
                    <div class="carousel-inner">
                    ...
                    @if ($featuredEvents->count() > 1)
                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselControlFEmini" data-bs-slide="prev" style="left: 0pt">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Previous</span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="#carouselControlFEmini" data-bs-slide="next" style="right: 0pt">
                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Next</span>
                        </button>
                    @endif
    ...
    <div class="container-fluid mb-4">
        ...
        <div class="row">
            ...
            @else
                <div id="carouselControlLEMINI" class="carousel carousel-dark slide" data-bs-interval="false">
                    <div class="carousel-inner">
                        @foreach ($latestEvents as $key=>$activelatestevent)
                            <div class="carousel-item{{$key ===0  ? ' active' : '' }}">
                                <div class="row row-cols-1 row-cols-md-3 g-4 px-3">
                    ...
                    @if ($latestEvents->count() > 1)
                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselControlLEMINI" data-bs-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Previous</span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="#carouselControlLEMINI" data-bs-slide="next" style="right: 0pt">
                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Next</span>
                        </button>
                    @endif
    ...
    <div class="container-fluid mb-4">
        ...
        <div class="row">
            ...
            @else
                <div id="carouselControlPEmini" class="carousel carousel-dark slide" data-bs-interval="false">
                    <div class="carousel-inner">
                    ...
                    @if ($popularEvents->count() > 1)
                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselControlPEmini" data-bs-slide="prev" style="left: 0pt">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Previous</span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="#carouselControlPEmini" data-bs-slide="next" style="right: 0pt">
                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Next</span>
                        </button>
                    @endif
    ...
    <div class="container-fluid mb-4">
        ...
        <div class="row">
            ...
            @else
                <div id="carouselControlRecmini" class="carousel carousel-dark slide" data-bs-interval="false">
                    <div class="carousel-inner">
                    ...
                    @if ($recommendedEvents->count() > 1)
                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselControlRecmini" data-bs-slide="prev" style="left: 0pt">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Previous</span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="#carouselControlRecmini" data-bs-slide="next" style="right: 0pt">
                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Next</span>
                        </button>
                    @endif
