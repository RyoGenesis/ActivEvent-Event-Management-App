...
class HighlightEventDatatables extends Datatables
{
     ...
     * @var String
     */
    protected $title = 'Highlighted Events';
    ...
    {
        return route('ladmin.event.highlight.index', ['datatables']);
    }
    ...
    {
        return ladmin()->view('highlight._parts.table-action', $data);
    }
